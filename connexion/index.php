...
<body>
    ...
    ?>
	<div class="limiter">
		<div class="container-login100" style="background-image: url('images/img8.jpg');">
			<div class="wrap-login100 p-t-30 p-b-50">
				<span class="login100-form-title p-b-41">
					Connectez - Vous
				</span>
				<form class="login100-form validate-form p-b-33 p-t-5" action="/ipres/controller/userController.php">
